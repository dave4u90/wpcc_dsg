...
class User < ActiveRecord::Base
	attr_accessor :product_instance_id, :check_password
...
#	after_create :add_admin
	...
	validates :password, presence: true, length: { minimum: 7 }, if: Proc.new { |user| user.check_password.nil? }
	validates :password_confirmation, presence: true, if: Proc.new{ |user| user.check_password.nil? }
